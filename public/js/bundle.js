        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'Success') {
              (0, _alert.showAlert)('success', 'Logged In Successfully'); // NOTE how to set timeout in js
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'error loggingOut! Try again');
...
var stripe = Stripe('pk_test_bIXs7upVjezHnhynWdip59zb00d0hyrj2h');

var bookGame = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(gameId, event) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            (0, _alert.showAlert)('error', 'Tournament has ended, Please try for another one');
            event.target.innerHTML = 'Purchase';
            return _context.abrupt("return");

          case 5:
            _context.next = 7;
            return (0, _axios.default)("http://localhost:2000/api/purchase/checkout-session/".concat(gameId));
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'You have already Purchased the game');
            event.target.innerHTML = 'Purchase';
            return _context.abrupt("return");
          ...
          case 17:
            ...
            _context.t0 = _context["catch"](0);
            event.target.innerHTML = 'Purchase';
            (0, _alert.showAlert)('error', 'If you are not logged, Please login and try again ');
  ...
  return function bookGame(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.bookGame = bookGame;
...
var bookBtn = document.querySelector('#book-game'); //VAlUES
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (event) {
    ...
    (0, _stripe.bookGame)(gameId, event);
  });
